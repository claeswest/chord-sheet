...
import { GEMINI_TEXT_MODEL, GEMINI_IMAGE_MODEL, geminiUrl, geminiFetch } from "@clavos/core/ai";
...
Rules: No text, letters, words, or sheet music. Rich golden and amber tones, warm sunlight, soft lens flare, honey glow. Rolling hills, candlelight interiors, autumn leaves, sunset haze. Cosy and inviting. No people. End with: "golden warm light, amber tones, cosy atmosphere, high quality, 4k"`,
  ...
  photoreal: `You are a landscape and location photographer. Given a song title, artist, and lyrics, write a single concise image generation prompt (max 60 words) for a PHOTOREALISTIC background image.
Rules: No text, letters, words, or sheet music. A real place, photographed — an empty road at dusk, rain on a window, a harbour at first light, a field, a room with the light coming in. Natural light, believable depth of field, real materials and weather. Choose the place from the song's mood. No people, no faces. End with: "photorealistic, natural light, shallow depth of field, high detail, 4k"`,
