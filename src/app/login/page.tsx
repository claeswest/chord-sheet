      ...
      <div className="bg-white rounded-2xl shadow-sm border border-zinc-100 p-10 w-full max-w-sm text-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 bg-zinc-900 text-white text-sm font-medium py-2.5 rounded-lg hover:bg-zinc-700 transition-colors"
            >
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 border border-zinc-200 text-zinc-700 text-sm font-medium py-2.5 rounded-lg hover:bg-zinc-50 transition-colors"
            >
