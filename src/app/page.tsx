          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
              ...
              <div className="flex-1 w-full flex flex-col gap-2">
                <div className="relative rounded-2xl overflow-hidden border border-zinc-200 shadow-xl">
              ...
              {/* After */}
              <div className="flex-1 w-full flex flex-col gap-2">
                <div className="relative rounded-2xl overflow-hidden border border-indigo-300 shadow-xl" style={{ boxShadow: "0 0 0 1px rgba(99,102,241,0.3), 0 20px 40px -8px rgba(99,102,241,0.35)" }}>
