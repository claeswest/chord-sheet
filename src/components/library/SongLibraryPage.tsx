      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 px-6 py-6 min-w-0">
          <div>
            ...
            <div className={`sticky top-0 z-20 bg-white pt-4 pb-4 flex items-center gap-3 flex-wrap -mx-6 px-6 border-b border-zinc-100 shadow-sm transition-opacity duration-200 ${loading ? "invisible" : ""}`}>
