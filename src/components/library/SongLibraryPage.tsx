      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 px-6 py-6 min-w-0">
          <div>
            ...
            <div className={`sticky top-0 z-20 bg-white pt-1 pb-4 flex items-center gap-3 flex-wrap -mx-6 px-6 border-b border-zinc-100 shadow-sm transition-opacity duration-200 ${loading ? "invisible" : ""}`}>
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
                ...
                <div className="sticky top-0 z-10 flex items-center gap-4 px-5 py-2 border-b border-zinc-200 bg-zinc-100">
                  ...
                  <button onClick={() => handleSortClick("date")} className="hidden md:flex items-center gap-1 justify-end text-xs font-semibold text-zinc-500 uppercase tracking-wider w-32 shrink-0 hover:text-zinc-800 transition-colors p-0">
                    Updated
