    ...
    >
      ...
      >
        <div className="flex items-center px-5 py-3 bg-gradient-to-b from-black/60 to-transparent">
          {/* Logo */}
          <Link href="/songs" className="text-sm font-bold tracking-tight text-white hover:opacity-75 transition-opacity px-3 py-1.5 rounded-lg bg-[#302b63]/80 backdrop-blur-sm" style={{ fontFamily: "var(--font-nunito)" }}>
          ...
          <Link
            href="/songs"
            className="text-sm font-bold text-white hover:opacity-75 transition-opacity px-3 py-1.5 rounded-lg bg-[#302b63]/80 backdrop-blur-sm flex items-center gap-1.5"
          >
